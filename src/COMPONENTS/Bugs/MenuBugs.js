...
export default function MenuBugs() {
    return (
        <div className="menu">
            <div className="account">
                <div className="avatar">
                    <img src={require("../../assets/imgAnother/download.jfif.webloc")} alt="123" />
                </div>
            ...
            <div className="control">
                <div>
                    ...
                    <NavLink className="text-dark" activeStyle={{ color: 'blue' }} to="/bugs" activeClassName="active font-weight-bold text-primary" >Bugs Board</NavLink>
                </div>
                <div>
